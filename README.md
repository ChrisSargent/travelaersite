...
5. Build the Node / Express server code: `npm run server`
6. Test that it's working correctly with: `npm run serve` and check localhost:8085
7. Update Sentry: `npm run update_sentry`
