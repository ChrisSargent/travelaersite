...
const Mosaic = ({tiles, compName, type}) => {
  ...
  switch (type) {
    ...
    case 'team':
      ...
      filters = <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" id="svg-filters">
                  <defs>
                    <filter id="filter-bw">
                      <feColorMatrix type="matrix" colorInterpolationFilters="sRGB" values="
                        0 1 0 0.3 0
                        0 1 0 0.3 0
                        0 1 0 0.3 0
                        0 1 0 1 0 "/>
                    ...
                    <filter id="filter-blue">
                      <feColorMatrix colorInterpolationFilters="sRGB" type="matrix" values="
                        0     0     0     0     0
                        0     0.57     0     0     0
                        0     0     0.75     0     0
                        0     0     0     1     0 "/>
