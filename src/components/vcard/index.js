  ...
  return (
    <div className="vcard">
      ...
      <div className={css.column}>
        ...
        {props.coRegNumber && <span className={css.item}><span className={css.label}>Company Registration Number:&nbsp;</span>{props.coRegNumber}</span> }
        {props.coTaxNumber && <span className={css.item}><span className={css.label}>Company Tax Number:&nbsp;</span>{props.coTaxNumber}</span> }
      </div>
    </div>
  );
}
